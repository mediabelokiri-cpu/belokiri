...
export default async function Footer() {
  ...
  const settings = res.settings || defaultSiteSettings;
  const identity = settings.identity || defaultSiteSettings.identity;
  const social = settings.social || defaultSiteSettings.social;
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-8">
          ...
          <div className="lg:col-span-4 space-y-4">
            <Link href="/" className="inline-block">
              <Image
                src={identity.logoWhiteUrl || "/images/logo-belokiri-white.png"}
                alt={identity.siteName || "BELOKIRI"}
                width={190}
                height={36}
            ...
            <p className="text-white text-sm font-bold uppercase tracking-wider">
              &ldquo;{identity.tagline || "Liar seperlunya, jenaka secukupnya"}&rdquo;
            </p>
