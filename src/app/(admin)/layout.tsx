...
export const metadata = {
  title: "Meja Redaksi & CMS | NALAR",
  description: "Panel kurasi, publikasi naskah, dan manajemen editorial NALAR.",
};
  ...
  return (
    <div className="min-h-screen bg-[#fafaf9] flex flex-col font-sans">
      ...
      <footer className="border-t border-zinc-200 bg-white py-6 text-center text-xs text-zinc-400 font-medium">
        NALAR Meja Redaksi • Standar Jurnalisme Berimbang, Tajam & Beretika
      </footer>
    </div>
  );
}
